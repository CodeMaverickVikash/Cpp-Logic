...
6. It cannot access the members directly by their names and need object (object_name.member_name) to access any member.
...
class Complex{
    int a, b;
    friend Complex sumComplex(Complex o1, Complex o2); // sumComplex function have permision to access private datamember in which they are declared
    public:
